...
\begin{itemize}
  \item \ddd{Normalization of ratings (feature scaling)}: adjusting values measured on different scales to notionally common scale, often prior to averaging.
    ...
    \end{itemize}
  \item \ddd{Normalized values (normalization)}: creation of \emph{dimensionless}, or scaled, versions of samples with the intention of minimizing the effect of gross \hyperref[Subsection: Outliers]{\dlink{anomalies/outliers}}.
