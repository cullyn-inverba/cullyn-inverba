...
\begin{itemize}
  ...
  \begin{itemize}
    ...
    \begin{itemize}
      ...
      \item Major associated distributions include \hyperref[Subsection: Primer: Probability Distributions]{\ulink{Bernoulli and Binomial}} distributions, but geometric distributions deserve a mention as well;
        \begin{itemize}
...
\begin{itemize}
  ...
  \item \ddd{Expected (mean) value \(\mu, E[X], \bar{X}\)}: the expected mean of the \hyperref[Section: Data Fundamentals]{\ulink{population}}, or in case of random sampling, the expected mean of numerous samples, i.e.,
  \[%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
