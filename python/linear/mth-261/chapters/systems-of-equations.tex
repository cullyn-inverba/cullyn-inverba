...
\begin{itemize}
  ...
  \begin{itemize}
    ...
    \item If the system has a \hyperref[Singular Value Decomposition]{\dlink{non-singular matrix}}, then it is also the only solution.
    \item If the system has a \hyperref[Singular Value Decomposition]{\dlink{singular matrix}} then there are infinite solutions and consists of a solution set with the following properties:
    \begin{itemize}
      ...
      \item Numerical solutions to a homogeneous can be found with \hyperref[Singular Value Decomposition]{\dlink{singular value decomposition}}.
    \end{itemize}
  \end{itemize}
  \bigskip
