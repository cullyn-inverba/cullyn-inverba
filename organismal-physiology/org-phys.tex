...
\begin{itemize}
    ...
    \subsubsection{Concentration gradients}
        \begin{itemize}
            ...
            \item More accurately: \(\dfrac{\Delta C}{X}\) where \(X\) is the distance separating (boundary layer) the regions of concentraion.
            \item \textbf{Fick diffusion equation}: \(J=D\dfrac{\Delta C}{X}\)
                \begin{itemize}
                    \item \(J\) is the net number of solute molecules passing into the low-concentration region from the high-concentraion region.
                ...
                \end{itemize}
            \item Each solute diffuses according to its own concentraion gradient.
    ...
    \begin{itemize}
        ...
        \item \textbf{Permeability}: the ease at which the solute can move through the membrane by diffusion.
            ...
            \end{itemize}
        \item \textbf{Faciliated diffusion}: moves with or against concentration gradient, though it uses energy due to use of channel or protein transporters.
        \begin{itemize}
            \item Instead it always occurs in the direction of electrochemical equilibrium.
            \item Solutes are transported much faster than they are in simple diffusion.
...
\subsection{Channels and Trapsporters}
\begin{itemize}
    \item 
\end{itemize}
...
{\color{darklc}Excerpt from Chapter 26: Water and Salt in Physiology $\mapsto$}
\begin{itemize}
    \item 
\end{itemize}
%\endgroup
