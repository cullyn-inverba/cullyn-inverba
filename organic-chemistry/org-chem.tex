...
\begin{itemize}
    ...
    \begin{itemize}
        \item \textbf{Heat of reaction}: the total change in enthalpy (\(\Delta H^\circ\)). 
            \begin{itemize}
                \item The signum (positive or negative) indicates the direction in which the energy is exchanged from the {\color{o-Sun}perspective of the system}.
                \item A {\color{pos}positive \(\Delta H^\circ\)} indicates that the system {\color{pos}increased} in energy due to transfer {\color{pos}from the surroundings}.
                    \item I.e., indicates an {\color{pos}\textbf{exothermic}} process.
                \item A {\color{neg}negative \(\Delta H^\circ\)} indicates that the system {\color{neg}decreased} in energy due to transfer {\color{neg}to the surroundings}.
                    \begin{itemize}
                        \item i.e., indicates an {\color{neg}\textbf{endothermic}} process.
                    \end{itemize}
        ...
        \item Predicting sign and magnitude:
            \begin{enumerate}
                \item Identify all bonds that are {\color{pos}broken} or {\color{neg}formed}.
                \item Then find the bond dissociation energies.
                \item Apply the signum to the bonds in respect to the system based on {\color{pos}breakage} or {\color{neg}fromation}.
