...
\begin{itemize}
    \item \textbf{Conformations}: the variety of possible three-dimensional shapes of a compound that are interchangeable by low energy pathways.
        \begin{itemize}
    ...
    \begin{itemize}
        \item \textbf{dihedral (torsional) angle}: the angle between atoms of front and back carbons as the $\sigma$ bonds rotates.
        \item There are an infinite number of possbile conformations, but there are conformations of maximum and minium energy.
            \begin{itemize}
                \item \textbf{Staggered conformation}: {\color{o-Sun}lowest energy} conformation.
                \item \textbf{Eclipsed conformation}: the {\color{o-Sun}highest energy} conformation.
            \end{itemize}
    ...
    \begin{itemize}
        ...
        \item \textbf{Gauche interaction}: unfavorable intereaction between methyl groups, causing an increases in energy due to electron cloud repulsion.
            \begin{itemize}
                \item Gauche intereaction is a type of steric intereactions present at \(\pm\ang{60}\).
                \item Has an energy cost \SI{3.8}{kJ\per\mole}
            \end{itemize}
        \item Total cost of butane: \SI{19}{kJ\per\mole}.
            \begin{itemize}
                \item Energy cost of eclipsing \ch{CH3}: \SI{11}{kJ\per\mole}
