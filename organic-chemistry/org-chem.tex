    ...
    \begin{itemize}
        ...
        \item "Legal" moves: 
            \begin{itemize}
                ...
                \item Every resonance structure can be built through a combination of about three moves.
            \end{itemize}
    \end{itemize}
    \subsubsection{Patterns in Drawing Resonance Structures}
    \begin{itemize}
        \item \textbf{Vinylic}: two carbon atoms bearing the double of a carbon-carbon double bond.
        \item \textbf{Allylic}: atoms connected directly to vinylic positions.
        \item \textbf{Allylic lone pair}: an atom that contains lone pairs and adjacent to a carbon-carbon double bond.
            \begin{itemize}
                \item Any lone pair next to a $\pi$ bond can serve the same function for the purposes of drawing resonance structures.
                \item Two pushes of electrons will be ultimately be needed. 
            \end{itemize}
        \item \textbf{Allylic carbocation}: a positive charge located in an allylic position.
            \begin{itemize}
                \item Only one arrow required, represents the $\pi$ bond $\rightarrow$ $\pi$ bond push.
                \item \textbf{Conjugated}: when two $\pi$ bonds are separated by a single $\pi$ bond.
            \end{itemize}
        \item 
    \end{itemize}
