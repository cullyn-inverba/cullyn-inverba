...
\begin{itemize}
    \item \textbf{Chan-Ingold-Prelog system}: a system of nomenclature for Identifying each enantiomer individually.
        \begin{enumerate}
            ...
            \item Determin the configuration, i.e., sequence of 1-2-3 groups is {\color{true}clockwise (R)} or {\color{false}counterclockwise (S)}.
        \end{enumerate}
...
\begin{itemize}
    \item Enantiomers exhibit identical physical properties.
    \item Enantiomers exhibit different behavior to plane-polarized light.
        \begin{itemize}
    ...
    \item \textbf{Optically active}: property of compounds that rotate the plane-polarized light.
        \begin{itemize}
            ...
            \item {\color{o-Sun}Chiral compounds are optically active}, while achiral compounds are not.
        \end{itemize}
    ...
    \item Specific rotation for enantiomers are {\color{o-Sun}equal in magnitude} but {\color{o-Sun}opposite in direction}.
        \begin{itemize}
            ...
            \item The direction of polarized light, however, is dependent on conditions, and can change based on temperature or wavelength even with the same given configuration.
        \end{itemize}
    ...
    \begin{itemize}
        ...
        \item \textbf{Enantiomeric excess (\(ee\))}: when a solution containing both enantiomers in unequal amounts, appearing optically active.
            \begin{itemize}
                \item \(\%~ee = \dfrac{|\text{observed}~\alpha|}{|\text{pure}~\alpha|} \times 100\%\)
            \end{itemize}
    \end{itemize}
\end{itemize}
