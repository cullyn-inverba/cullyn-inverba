...
\begin{itemize}
    ...
    \end{itemize}
    \item Early investigation by Ingold and Hughes revealed {\color{o-Sun}concerted}, i.e., simultanesous occurrences of reaction mechanisms, and {\color{o-Sun}stepwise}, i.e., one mechanism that allows for a different mechanism(s) to take place.
    \item Conditions that favor the concerted process (\(S_N2,~E2\)) will be explored first, while the {\color{G-Moon}stepwise (\(S_N1,~E1\))} will be explored later.
\end{itemize}
