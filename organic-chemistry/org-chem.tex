...
\begin{itemize}
    ...
    \item \textbf{Gibbs free energy (\(\Delta G^\circ\))}: the maximum amount of non-expansion work that can be extracted from a closed system.
        ...
        \end{itemize}
    \item Often {\color{surr}\(\Delta H^\circ\)} is has a much greater contribution than {\color{sys}\(T\Delta S^\circ\)}, so enthalpy is commonly an indicator of the spontaneity.
        \begin{itemize}
            \item When more bond energy (\(\Delta H^\circ\)) is {\color{pos}broken} than formed, then the \(\Delta G^\circ\) is {\color{neg}decreased}, which {\color{pos}increases spontaneity}.
            \item When more bond energy (\(\Delta H^\circ\)) is {\color{neg}formed} than released, then the \(\Delta G^\circ\) is {\color{pos}increased}, which {\color{neg}decreases spontaneity}.
        \end{itemize}
    \item However, temperature has great effect on entropy of the system:
        \begin{itemize}
            \item An increase in temperature increases entropy of the system, which is {\color{o-Sun}not favorable}, as it {\color{pos}increases \(\Delta G^\circ\)}.
            \item A {\color{neg}decrease in temperature} is leads to more bonds being {\color{neg}formed}, which {\color{neg}decreases} entropy of the system as energy is transferred to the surroundings.
                \begin{itemize}
                    \item This {\color{o-Sun}favorable}, as it {\color{neg}decreases \(\Delta G^\circ\)}.
                \end{itemize}
        \end{itemize}
\end{itemize}
