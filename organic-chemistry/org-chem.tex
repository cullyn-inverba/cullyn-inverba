...
\begin{itemize}
    ...
    \begin{itemize}
        \item Relative acid strength can be determind by comparing conjugate bases. 
            \begin{itemize}
                \item The {\color{o-Sun}more stable} the conjugate base, the {\color{o-Sun}stronger} the acid.
        ...
        \item \textbf{Orbitals}: negative charges on atoms with lower hybridization result in greater stability due to proximity to positive nucleus, i.e., \(sp > sp^2 > sp^3\)
            \begin{itemize}
