\documentclass[plain]{inVerba-notes}
\begin{document}
...
\begin{enumerate}
    ...
    Draw plots of current vs.\ time when the recordings are made under each of the following experimental conditions. For each, overlay the new response on the control plot. Briefly explain your reasoning next to each plot. Note that a dashed line is provided at \SI{0}{nA}.
