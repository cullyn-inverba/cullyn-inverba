...
\begin{itemize}
  ...
  \begin{itemize}
    \item The shapes of data distributions are \hyperref[Section: Probability Functions]{\dlink{functions of probability theory}}; a more in-depth explanation will be covered later, but for now coverage of common distribution types might be useful.
