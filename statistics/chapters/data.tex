  ...
  \begin{itemize}
    ...
    \item \ddd{Histogram}: a representation of the \emph{distribution} of numerical data via the use of \emph{binning}.
      \begin{itemize}
        ...
        \item Histograms of \emph{proportion} are usually better for \emph{quantitative} analysis, as they are typically easier to compare across datasets, but can take extra effort to create.
      \end{itemize}
