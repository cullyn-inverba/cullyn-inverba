...
\begin{itemize}
  ...
  \begin{itemize}
    ...
    \]%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    \begin{itemize}
      \item Note: this is sample variance, so the divisor (\hyperref[Subsection: Degrees of Freedom]{\ulink{degree of freedom \(df\)}}) \(\frac{1}{n-1}\) is still present, but will be partitioned along with variance in order to interpret the results.
    \end{itemize}
