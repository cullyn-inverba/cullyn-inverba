...
\begin{itemize}
  ...
  \begin{itemize}
    \item \ddd{Parametric statistics}: based on the assumptions wherein sample data originate from a population that can be adequately modeled by a probability distribution with \OOO{a fixed set of parameters}.
