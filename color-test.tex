...
\begin{itemize}
        \item Cras ullamcorper auctor laoreet.\link{http://www.google.com}{google}
        \item 
    \begin{itemize}
...
Praesent lobortis turpis ac ligula congue dictum. Suspendisse sit amet varius tellus, sed venenatis\underline{\ulink{Hello}} velit. In consectetur massa consequat diam venenatis, tempor fringilla neque aliquet. Aliquam auctor ex vitae porttitor tincidunt. Mauris et diam tempus, auctor justo ut, dignissim velit. Interdum et malesuada fames ac ante ipsum primis in faucibus. Sed in finibus nunc, a blandit magna. 
...
\begin{itemize}
    \item Praesent ut semper urna, nec posuere odio
        \begin{itemize}
            ...
            \item \hyperref[Mini Section1]{\ulink{animals}}
            \item  In ac erat non est rutrum sodales eget nec nunc.
                \begin{itemize}
                    \item  Morbi felis nulla, gravida non blandit non, imperdiet ac purus.
                    \begin{itemize}
...
\section{Big Section}
\begin{itemize}
        \item \ulink{Cras ullamcorper auctor} laoreet. 
        \item \dlink{Nunc porta malesuada elementum}
        \item Cras ullamcorper auctor laoreet.
    \begin{itemize}
    \subsection{Mini Section}
        \item \jargon{Definition}: Cras faucibus gravida nibh.
