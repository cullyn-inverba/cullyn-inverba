...
\begin{secbox}{\hyperlink{43}{Principles of Electric Signaling}}{
    \begin{itemize}
        ...
        \item \textbf{Leak channels}: channels that allow \ch{K^+} to leak across the membrane and cause the membrane to reach a voltage at which equilibrium exists between the concentration gradient and electrical gradient, also known as equilibrium potential. 
        \item \textbf{Equilibrium potential}: when there is longer longer net movement of \ch{K^+}.
...
\begin{secbox}{\hyperlink{43}{Dissecting Action Potential}}{
    \begin{itemize}
        ...
        \begin{itemize}
            \item [1.] Influx of \ch{Na^+} repels intracellular cations, causing them to spread away from sodium channels. 
            ...
            \item [3.] Nearby voltage-gated \ch{Na^+} channels open, resulting in new action potential and further propagation. 
        \end{itemize}
