...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%% Chapter 50 %%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%% Chapter 51 %%%%%%%%%%%%%%%%%%%%%%%%%%%%
%\begingroup\setcounter{section}{49}
\clearpage
...
\begin{itemize}
    \item \textbf{Commensalism}: when one species benefits but the other ius unaffected.
    \item \textbf{Competition}: when individuals use the same resources.
    \item \textbf{Consumption}: occurs when one organism eats or absorbs nutrients from another.
    \item \textbf{Mutualism}: when two species interact in a way that confers fitness benefits to both.
    \item \textbf{Symmetric competition}: when interspecific competition between niches dercreases fitness, both persisting in reduced numbers.
    \item \textbf{Asymmetric competition}: when one species suffers greater fitness decline due to niche competition.
    \item \textbf{Competitive exclusion principle}: when two species occupy the exact same niche. 
    \item \textbf{Fundamental niche}: total range of environmental conditions a species can tolerate.
    \item \textbf{Realized niche}: portion of a fundamental niche that a species actually occupies.
    \item \textbf{Character dispalcement}: enables a species to exploit different resources, leading to niche differentiation.
    \item \textbf{Inducible defenses}: physical, chemical, or behavioral defensive traits that are induced in the prey in response to consumers.
    \item \textbf{Constitutive defense}: present in the absence of consumers.
\end{itemize}

\subsection{Community Structure}
\begin{itemize}
    \item A comminty structure has four key attributes: total number of species, the sum of interactions between species, relative abundance of those species, and the physical attributes of the community. 
    \item \textit{Bottum-up}: Sunlight, water, and other abiotic factors determin the abundance of primary producers which have an bottom up affect on the food web.
    \item \textit{Top down}: result of keystone species, which have much greater impact on the distribution and abundance of the surrounding species.
\end{itemize}

\subsection{Community Dynamics}
\begin{itemize}
    \item The impact of disturbance is a function of three factors: the type, frequency, and severity.
    \item \textbf{Disturbance regime}: in most cases disturbances occur with a predictable frequency and severity.
    \item \textbf{Succession}: the recovery that follows a disturbance.
    \item \textbf{Pioneering species}: high fecundity, low survivorship. Typically the first species to recover after a disturbance.
    \item \textbf{Facilitation}: when early-arriving species make conditions more favorable for the arrival of later species.
    \item \textbf{Tolerance}: existing species do not affect the probability that subsequent species become established.
    \item \textbf{Inhibition}: when one species inhibits the growth of another.
\end{itemize}
