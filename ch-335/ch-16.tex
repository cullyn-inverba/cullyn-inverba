...
\begin{itemize}
    ...
    \begin{itemize}
      ...
      \item \ch{CrO3} is a \emph{strong oxidizing} agent that is \emph{not soluble} in most organic solvents; it tends to explode in the presence of organic compounds and solvents.
          \begin{itemize}
            \item In water if forms chromic acid and anhydrides, from which salts such as sodium dichromate (\ch{Na2Cr2O7}) and PCC\@.
            \item Other chromium based oxidizing reagents:
              \begin{itemize}
                \item \ch{NaCrO4}: sodium chromate.
                \item \ch{K2Cr2O7}: potassium dichromate.
              \end{itemize}
          \end{itemize}
      
    \item \ddd{Pyridinium chlorochromate (PCC)}: \ch{[C5H5NH]\plus[CrO3Cl]−} --- a \emph{mild} oxidizing reagent primarily used for \emph{selective oxidation} of alcohols to \emph{aldehyde or ketones} rather than carboxylic acid.
  ...
  \begin{itemize}
    ...
    \begin{itemize}
      \item \textit{Trans}-alkene reactant (\rrr{acid catalyzed} in this case, but a \bbb{base catalyzed} would produce same product):
      ...
      \schemestart{}
        ...
        \arrow{->[\ch{H2O}][]}
        \chemfig{(<:[:80]H)(-[:-90]\ch{OH})(<[:120])-(-[:90]\ch{OH})(<:[:-60])(<[:-100]H)}
      \schemestop{}
      \bigskip
  ...
  \begin{itemize}
    ...
    \begin{itemize}
        ...
        \schemestart{}
          {\footnotesize\chemfig{*6(--=---)}}
          \arrow{->[\ch{KMnO4} (cold)][\bbb{OH}/\ch{H2O}]}[0,1.4]
          {\footnotesize\chemfig{*6(--(<\ch{OH})-(<\ch{OH})---)}}
        \schemestop{}
        \bigskip
        ...
        \schemestart{}
        {\footnotesize\chemfig{*6(--=(-)---)}}
        \arrow{->[\ch{OsO4}, NMO][\ch{NaHSO3}, \ch{H2O}]}[0,1.6]
        {\footnotesize\chemfig{*6(--(<\ch{OH})-(<\ch{OH})(<:[2])---)}}
        \+{,,10pt}
        {\footnotesize\chemfig{*6(--(<:\ch{OH})-(<:\ch{OH})(<[2])---)}}
        \schemestop{}
        \bigskip
    ...
    \begin{itemize}
        \item \ddd{Ozonolysis}: when the unsaturated bonds of alkenes, alkynes, or azo compounds (azo compounds not important for this class) are \emph{cleaved} with ozone.
        ...
        \schemestart{}
          \chemfig{(-[3])(-[5])=(-[1]H)(-[7])}
          \arrow{->[\ch{O3}][\ch{Me2S}]}
          \chemfig{(-[3])(-[5])=O-[,1,,,draw=none]O=(-[1]H)(-[7])}
        \schemestop{}
        \bigskip
  
        \begin{itemize}
          \item \ch{Me2S}: dimethyl sulfide; used as reducing agent that decomposes the intermediate (ozonide), making dimethyl sulfoxide (DMSO).
        \end{itemize}
        ...
        \schemestart{}
          \chemfig{(-[3])(-[5])=(-[1]-)(-[7])}
          \arrow{->[\ch{O3}][\ch{Me2S}]}
          \chemfig{(-[3]H)(-[5]H)=O-[,0.8,,,draw=none]+-[,0.8,,,draw=none]O=(-[1]-)(-[7])}
        \schemestop{}
        \bigskip
        ...
        \schemestart{}
          {\footnotesize\chemfig{*6(---=(-)--)}}
          \arrow{->[\ch{O3}][\ch{Me2S}]}
          {\footnotesize\chemfig{*6(---(=[,0.6]O)-[,,,,draw=none](-)(=[:-30,0.6]O)--)}}
          \arrow{}
          \chemfig{-[:-30](=[:-90]O)-[:30]-[:-30]-[:30]-[:-30]-[:30](=[:90]O)}
        \schemestop{}
        \bigskip
        ...
        \schemestart{}
          \chemfig{R-~-R'}
          \arrow(1--2){->[\ch{O3}]}
          \chemname[-40pt]{\chemfig{(=[3]O)(-[5]R)-(=[1]O)(-[7]R')}}{diketone}
          \arrow(@1--){->[\ch{O3}]}[-90,0.8]
          \chemname[-40pt]{\chemfig{(=[2]O)(-[:210]R)-[:-30]O-[:30](=[2]O)(-[:-30]R')}}{anhydride}
          \arrow{->[\ch{H2O}]}
          \chemfig{(=[2]O)(-[:210]R)-[:-30]OH}
          \+
          \arrow{0}[,0]
          \chemfig{HO-[:30](=[2]O)(-[:-30]R')}
        \schemestop{}
        \bigskip
        ...
        \medskip
        \schemestart{}
          \chemfig{(=[2]O)(-[:210]-[:150])-[:-30]OH}
          \+
          \arrow{0}[,0]
          \chemfig{HO-[:30](=[2]O)(-[:-30]-[:30]-)}
          \arrow{0}[,0] \quad \(\Longrightarrow \) \quad
          \chemfig{-[:30]-~--[:30]-}
        \schemestop{}
        \bigskip
        ...
        \begin{itemize}
          \item Terminal alkynes generate a carboxylic acid and a formic acid; formic acid will break down to \ch{CO2}.
        \end{itemize}
    \end{itemize}
