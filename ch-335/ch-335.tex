  ...
  \item Some relevant facts to start:
    \begin{itemize}
      \item \ddd{Alkene}: a hydrocarbon that contains a carbon–carbon double bond.
        \begin{itemize}
          \item IUPAC recommends using alkene for only acyclic hydrocarbons with just one double bond; an \ddd{olefin} is a hydrocarbon with one more double bonds.
        \end{itemize}
...
\begin{itemize}
  ...
  \subsubsection{Hydrohalogenation}
  \begin{itemize}
  ...
  \ddd{Addition of Water or Alcohol (ROH)}: analogous to that of hydrohalogenation (HX); both of which involve a carbocation intermediate, syn/anti stereochemistry, and Markovnikov regioselectivity.
    \begin{itemize}
      ...
      \schemestart{}
        ...
        \arrow{->}[,,shorten <=12pt]
        \chemname{\chemfig{\rrr{H}-[:-90,.8]-[:-30]-[:30](-[:160,0.3,,,draw=none]\cat)(-[:90,.8])-[:-30]-[:30]}}{\ang{3} carbocation intermediate}
        \arrow{->[\bbb{\ch{H2O}}]}
  ...
  \begin{itemize}
      \item \ddd{Oxymercuration-Demercuration} is another electrophilic addition organic reaction that transforms an alkene into a neutral alcohol.
        \begin{itemize}
          ...
          \hspace{-20pt}
          \schemestart{}
            \chemname{\chemfig{CH_3-C(=[:-90]O)-OH}}{acitic acid, OAc}
            \arrow{->}[,,shorten <=8pt]
            \chemname{\chemfig{CH_3-C(=[:-90]O)-\bbb{O^-}}}{acitate, \ch{AcO-}}
          \schemestop{}
          \end{center}
          \medskip
      ...
      \begin{itemize}
        ...
        \item 
          ...
          \schemestart{}
            \dots
            \arrow(--[braces]){->}[0,.9]
            \chemname{\chemfig{-[:30]@{c1}*3(-<{\cat{}Hg}(-\ch{OAc})>)}
            \+
        ...
        \end{itemize}
      \end{itemize}
    \subsubsection{Water/Alcohol Practice Problems}
    \begin{enumerate}
      \item 
      \schemestart{}
      ...
      \schemestart{}
        ...
        \chemname{\chemfig{-[:-30]-[:30]*3(-<{\cat{}Hg}(-\ch{OAc})>)}
            \+
      ...
      \item Very similar to \hyperref[oxymercuration-num-7]{\dlink{question 7}} which I did first since it was in lecture.\label{oxy-num-6}
      ...
      \schemestart{}
        \dots
        \arrow(--[braces]){->}[0,.8]
        \chemname{\chemfig{*6(---(<:\rrr{H})-(<\bbb{OH})--)}}{\fff{Anti}}
        \+
        \chemname{\chemfig{*6(---(<\rrr{H})-(<:\bbb{OH})--)}}{\fff{Anti}}
      \schemestop{}
      \bigskip
      
      \item Very similar to \hyperref[oxy-num-6]{\ulink{question 6}} (was done in lecture)\label{oxymercuration-num-7}
  ...
  \begin{itemize}
    ...
    \schemestart{}
        ...
        \chemname{\chemfig{*6(--(-)-(<\rrr{OH})-(<\bbb{H})(<:[:30])--)}}{\ttt{Syn}}
        \+
        \chemname{\chemfig{*6(--(-)-(<:\rrr{OH})-(<:\bbb{H})(<[:30])--)}}{\ttt{Syn}}
    \schemestop{}
    \bigskip
  ...
  \begin{itemize}
    ...
    \arrow(--[braces]){->}
    \chemname{\chemfig{(<[:90]\bbb{Br})(-[:-130])-<:[:-90]\rrr{Br}}}{\fff{Anti}}
    \+
    \chemname{\chemfig{(<:[:90]\bbb{Br})(-[:-130])-<[:-90]\rrr{Br}}}{\fff{Anti}}
    \schemestop{}
    \chemmove[dash pattern= on 1pt off 1pt]{
