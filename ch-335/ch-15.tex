...
\begin{itemize}
  ...
  \begin{itemize}
    ...
    \schemestart{}
      ...
      \arrow{->[\bbb{\ch{Br-}}]}
      \chemname{\chemfig{R-[:-30](-[:210]\bbb{Br})=(-[:30]H)-[:-30]H}}{vinyl halide}
    \schemestop{}
    ...
    \begin{itemize}
      ...
      \schemestart{}
        ...
        \arrow{->[\bbb{\ch{Br-}}]}
        \chemname{\chemfig{R-[:-30](-[:-90]\bbb{Br})(-[:210]Br)-(-H)(-[:45]H)-[:-45]H}}{geminal halide}
      \schemestop{}
      \medskip
      ...
      \schemestart{}
        ...
        \chemname{\chemfig{->:[:30](-[:90]\bbb{I})(<[:-90]Br)-(-H)(-[:45]H)-[:-45]H}}{\ttt{rectus}}
        \+
        \chemname{\chemfig{(<:[:90]-[:150])(-[:-90]\bbb{I})(<[:150]Br)-(-H)(-[:45]H)-[:-45]H}}{\fff{sinister}}
      \schemestop{}
      \medskip
    ...
    \schemestart{}
      ...
      \chemname{\chemfig{R-[:-30](-[:210]\bbb{Cl})=(-[:30]H)(-[:-30]R')}}{\ttt{zusammen}}
      \+{,,-10pt}
      \chemname{\chemfig{\bbb{Cl}-[:-30](-[:210]R)=(-[:30]H)(-[:-30]R')}}{\fff{entegen}}
    \schemestop{}
    \medskip
    \begin{itemize}
      ...
      \schemestart{}
        ...
        \arrow{->[HCl]}
        {\scriptsize\chemname[-10pt]{\chemfig{[:-30]*6(-=-(-\chemabove[6pt]{}{\cat}=(-[:-30]H)(-[:30]))=-=)}}{preferred}}
        \quad{}or\quad
      ...
      \schemestart{}
        ...
        \arrow(--[braces]){->[\bbb{\ch{Cl-}}]}
        \chemname{{\scriptsize{\chemfig{[:-30]*6(-=-(-[:-30](-[:240]Cl)-(-[:-30]H)(-[:30]))=-=)}}}}{\fff{entegen}}
        \+
        \chemname{{\scriptsize{\chemfig{[:-30]*6(-=-(-[:-30](-[:240]Cl)-(-[:30]H)(-[:-30]))=-=)}}}}{\ttt{zusammen}}
      \schemestop{}
      \bigskip
    \end{itemize}
  \end{itemize}
  ...
  \begin{itemize}
      ...
      \schemestart{}
        ...
        \chemfig{R-\chemabove[6pt]{}{\cat}=(-[:30]\rrr{H})-[:-30]H}
        \arrow{->[\ch{H2O}]}
        \chemname{\chemfig{R-[:-30](-[:210]\bbb{OH})=(-[:30]H)-[:-30]H}}{enol}
      \schemestop{}
      ...
      \medskip
      \schemestart{}
      \chemname{\chemfig{R-[:-30](-[:210]HO)=(-[:30]H)-[:-30]H}}{enol}
      \arrow{<->>}
      \chemname{\chemfig{R-[:-30](=[:210]O)-(-H)(-[:45]H)-[:-45]H}}{keto}
      \schemestop{}
      \medskip 
      ...
      \item \ddd{Aldehyde}: generally created by removing a hydrogen from an alcohol; in our case it is generated by the \emph{anti-Markonikov} reaction that results in a terminal enol, which then undergoes tautomerization and produces the aldehyde as the major product.
  \end{itemize}
  ...
  \begin{itemize}
      ...
      \item Alkyne \to\ \emph{trans}-alkene; using generation of free radicals (\bbb{\bullet}, single electron) that pair up with another electron generated by the dissociation of Na \to\ \rrr{\ch{Na+}}\plus\ \bbb{\ch{e-}} to create a free pair of electrons that than receive a hydrogen from \ch{NH3}:
