...
\begin{itemize}
  \item \jjj{Least-squares}: a standard approach in regression analysis to approximate the solution of systems with more equations than unknowns by minimizing the sum of the squares of the residuals, i.e.,
  \[%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
