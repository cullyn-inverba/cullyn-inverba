  ...
  \begin{itemize}
    ...
    \begin{itemize}
      ...
      \begin{itemize}
        ...
        \item The intuition described here will be more clear when the \hyperref[Matrix Determinant]{\dlink{determinant}} is discussed in more detail.
      \end{itemize}
    \end{itemize}
...
\begin{itemize}
  ...
  \begin{itemize}
    ...
    \]%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    \begin{itemize}
      \item Determining the weights will be discussed later using \hyperref[Matrix Vector Multiplication]{\dlink{matrix computations}}.
    \end{itemize}
  ...
  \item %\hyperref[tbd]{\dlink{Basis vectors can be changed}},%
   (fix link) so it's better to think of them as the ``rulers'' used to describe any other vector in the space.
\end{itemize}