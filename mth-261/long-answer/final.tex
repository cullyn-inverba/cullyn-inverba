...
\begin{enumerate}[align=left, leftmargin=0pt, labelindent=\parindent, listparindent=\parindent, labelwidth=0pt, itemindent=!]\color{minor}
  ...
  \item  Let \(\bm{u}=\begin{bmatrix*}[r] -2 \\ 1 \\ 1 \end{bmatrix*}\),  \(\bm{v}=\begin{bmatrix} 3 \\ 4 \\ 1 \end{bmatrix}\), and \(\bm{w}=\begin{bmatrix} 1 \\ 2\\ 0 \end{bmatrix}\) for 7(a), 7(b), and 7(c).
    ...
    \basec{\begin{align*}
      ...
      \rrr{\bm{x}} &= \begin{bmatrix} -4/3 \\ 11/3 \\ 3 \end{bmatrix} \\
      &\downarrow \\
      a &= -\frac{4}{3},\quad b = \frac{11}{3},\quad c = 3 \\
      &\downarrow \\
      -2&=-\tfrac{4}{3}(-1)^2+\tfrac{11}{3}(-1)3  \\
      4&=-\tfrac{4}{3}(1)^2+\tfrac{11}{3}(1)+3 \\
      2&=-\tfrac{4}{3}(3)^2+\tfrac{11}{3}(3)+3 \\
      && \text{{\scriptsize{\minimal{that worked?}}}}
    \end{align*}}
    \basec{\begin{itemize}
      \item I didn't think that was going to work. I feel like I did something wrong, and it happened to work. I mean, I knew it would work if \tbm{A} was full rank matrix, but I don't know if \tbm{A} was defined correctly. How were we supposed to do this?
    \end{itemize}}
