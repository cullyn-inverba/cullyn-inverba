...
\begin{center}
  \Image{0.7\columnwidth}{images/week-8-e.jpg}
\end{center}
\bigskip
\begin{multicols}{2}
\begin{itemize}
  ...
  \begin{center}
    \Image{0.6\columnwidth}{images/week-8-e1.jpg}
  \end{center}
  
  \item \jjj{Pseudostratified columnar epithelium}:  has a smooth luminal surface, unlike the ``wavy'' or ``saw-toothed'' appearance of the efferent ductules. 
  
  \begin{center}
    \Image{0.65\columnwidth}{images/week-8-e2.jpg}
  \end{center}
  
  \item \jjj{Principal cells}: tall columnar cells (~75 to 80 µm) with numerous modified, long microvilli called stereocilia extend from their luminal surface.
  
  \begin{center}
    \Image{0.55\columnwidth}{images/week-8-e3.jpg}
  \end{center}
  
  \item \jjj{Muscular layer}: gradually increases in thickness through the length of the duct. 
  
  \begin{center}
    \Image{0.55\columnwidth}{images/week-8-e4.jpg}
  \end{center}
  
  \item \jjj{Circular layer of smooth muscle}:
  
  \begin{center}
    \Image{0.94\columnwidth}{images/week-8-e5.jpg}
  \end{center}
  
  \item \jjj{Tail}: consists of three layers of smooth muscle and stores sperm.
  
  \begin{center}
    \Image{0.6\columnwidth}{images/week-8-e6.jpg}
  \end{center}
...
\begin{center}
  \Image{0.89\columnwidth}{images/week-8-k.jpg}
\end{center}
\begin{multicols}{2}
\begin{itemize}
  \item \jjj{Duct}: resembles that of the epididymis except the luminal surface has longitudinal folds. It is lined with a pseudostratified columnar epithelium.
  
  \begin{center}
    \Image{0.6\columnwidth}{images/week-8-k1.jpg}
  \end{center}
  
  \item \jjj{Pseudostratified columnar epithelium}:
  
  \begin{center}
    \Image{0.85\columnwidth}{images/week-8-k2.jpg}
  \end{center}
  
  \item \jjj{Muscular layer}: consists of three layers of which sperm is transported through by peristaltic contractions of the smooth muscle.
  
  \begin{center}
    \Image{0.6\columnwidth}{images/week-8-k3.jpg}
  \end{center}
  
  \item \jjj{Inner longitudinal},
  
  \begin{center}
    \Image{0.6\columnwidth}{images/week-8-k4.jpg}
  \end{center}
  
  
  \item \jjj{Middle circular},
  
  \begin{center}
    \Image{0.6\columnwidth}{images/week-8-k5.jpg}
  \end{center}
  
  \item \jjj{Outer longitudinal},
  
  \begin{center}
    \Image{0.6\columnwidth}{images/week-8-k6.jpg}
  \end{center}
  
  \item \jjj{Ampulla}: resembles the rest of the ductus deferens except that its surface has more longitudinal folds.
  
  \begin{center}
    \Image{0.8\columnwidth}{images/week-8-k7.jpg}
  \end{center}
  
  \item \jjj{Longitudinal folds}:
  
  \begin{center}
    \Image{0.8\columnwidth}{images/week-8-k8.jpg}
  \end{center}
  
  \item \jjj{Lamina propria}: supports the epithelium.
  
  \begin{center}
    \Image{0.8\columnwidth}{images/week-8-k9.jpg}
  \end{center}
...
\begin{center}
  \Image{0.6\columnwidth}{images/week-8-l.jpg}
\end{center}
\begin{multicols}{2}
\begin{itemize}
  \item \jjj{Mucosa}:
  ...
  \begin{center}
    \Image{0.8\columnwidth}{images/week-8-l1.jpg}
    \Image{0.85\columnwidth}{images/week-8-l11.jpg}
  \end{center}
  
  \item \jjj{Pseudostratified columnar epithelium}:
  
  \begin{center}
    \Image{0.8\columnwidth}{images/week-8-l2.jpg}
  \end{center}

  \item \jjj{Lamina propria}:
  
  \begin{center}
    \Image{0.8\columnwidth}{images/week-8-l3.jpg}
    \Image{0.8\columnwidth}{images/week-8-l33.jpg}
  \end{center}
  
  \item \jjj{Muscular layer}:
  
  \begin{center}
    \Image{0.8\columnwidth}{images/week-8-l4.jpg}
  \end{center}
...
\begin{center}
  \Image{0.8\columnwidth}{images/week-8-m.jpg}
\end{center} 
\begin{multicols}{2}
\begin{itemize}
  \item \jjj{Tubuoalveolar glands}: 
  
  \begin{center}
    \Image{0.8\columnwidth}{images/week-8-m1.jpg}
  \end{center}
  
  \item \jjj{Glandular epithelium}: mostly simple columnar and cuboidal epithelial cells but may have regions of pseudostratified columnar epithelium.
  
  \begin{center}
    \Image{0.8\columnwidth}{images/week-8-m2.jpg}
  \end{center}
  
  \item \jjj{Pseudostratified columnar epithelium}:
  
  \begin{center}
    \Image{0.8\columnwidth}{images/week-8-m3.jpg}
  \end{center}
  
  \item \jjj{Corpora amylacea}: concretions of prostatic fluid in the lumen of some glands in older men. 
  
  \begin{center}
    \Image{0.8\columnwidth}{images/week-8-m4.jpg}
  \end{center}
  
  \item \jjj{Lamina propria}:
  
  \begin{center}
    \Image{0.8\columnwidth}{images/week-8-m5.jpg}
  \end{center}
...
\begin{center}
  \Image{0.7\columnwidth}{images/week-8-n.jpg}
\end{center} 
\bigskip
\begin{multicols}{2}
\begin{itemize}
  \item \jjj{Tunica albuginea}: sheath of dense irregular connective tissue that surrounds the erectile bodies.
  
  \begin{center}
    \Image{0.7\columnwidth}{images/week-8-n1.jpg}
  \end{center}
  
  \item \jjj{Corpora cavernosum}: a pair of vascular channels located dorsally within the penis. 
  
  \begin{center}
    \Image{0.7\columnwidth}{images/week-8-n2.jpg}
    \Image{0.7\columnwidth}{images/week-8-n22.jpg}
  \end{center}
  
  \item \jjj{Trabeculae}: consist of connective tissue and smooth muscle. 
  
  \begin{center}
    \Image{0.85\columnwidth}{images/week-8-n3.jpg}
  \end{center}
  
  \item \jjj{Helicine arteries}: normally coiled, but straighten and dilate on erection.
  
  \begin{center}
    \Image{0.88\columnwidth}{images/week-8-n4.jpg}
  \end{center}
  
  \item \jjj{Blood sinuses}:  labyrinth lined with endothelial cells and become filled with blood during erection.
  
  \begin{center}
    \Image{0.88\columnwidth}{images/week-8-n5.jpg}
  \end{center}
  
  \item \jjj{Central artery}: each corpus contains a single, central artery.
  
  \begin{center}
    \Image{0.88\columnwidth}{images/week-8-n6.jpg}
  \end{center}
  
  \item \jjj{Corpus spongiosum}: located ventrally within the penis.
  
  \begin{center}
    \Image{0.8\columnwidth}{images/week-8-n7.jpg}
  \end{center}
  
  \item \jjj{Urethra}: lined with a pseudostratified columnar epithelium.
  
  \begin{center}
    \Image{0.8\columnwidth}{images/week-8-n8.jpg}
  \end{center}
  
  \item \jjj{Mucous glands of littre and ducts}:  secrete a clear mucous on erection.
  
  \begin{center}
    \Image{0.8\columnwidth}{images/week-8-n9.jpg}
  \end{center}
  
  \item \jjj{Superficial fascia}: connective tissue that surrounds the penis with many blood vessels and nerves.
  
  \begin{center}
    \Image{0.6\columnwidth}{images/week-8-n10.jpg}
  \end{center}
...
\begin{itemize}\color{minor}
  ...
  \basec{\begin{itemize}
    \item Spermatogenesis is the process by which haploid spermatozoa develop form germ cells in the seminiferous tubules of testis.
    \item Spermiogenesis is the final stage of spermatogenesis, where the maturation of spermatids mature into spermatozoa.
  \end{itemize}}

  \item What is the effect of castration on the accessory sex glands (prostate and seminal vesicles)?
  \basec{\begin{itemize}
    \item Atrophy, reduction in size.
  \end{itemize}}

  \item Where is the primary source of testosterone?
  \basec{\begin{itemize}
    \item The leydig cells. 
  \end{itemize}}

  \item Where is the principal site of storage of spermatozoa in the male reproductive system?
  \basec{\begin{itemize}
    \item Epididymis (much of which in the tail?)
  \end{itemize}}

  \item Which organs are the major sources of seminal fluid?
  \basec{\begin{itemize}
    \item Seminal vesicle, prostate gland, and bulbo-urethral.
  \end{itemize}}

  \item What are the components of the blood-testis barrier, and what is its significance?
  \basec{\begin{itemize}
    \item Tight junctions between Sertoli cells isolate developing sperm from the vasculature which help prevent their immunological rejection. 
  \end{itemize}}
\end{itemize}
