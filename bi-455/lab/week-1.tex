...
\begin{itemize}
  \item \emph{\textbf{Interphase}}: The long period between mitosis (the \tsec{G\(_1\)}, \rrr{S}, and \ggg{G\(_2\)} phases) that takes place before division is able to occur again.
