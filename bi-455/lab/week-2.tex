...
\begin{itemize}
  ...
  \begin{itemize}
    ...
    \Image{0.9\columnwidth}{images/week-2-1a.jpg}
    \begin{multicols}{2}
    \begin{itemize}
      \item Cell nuclei
      
      \Image{0.8\columnwidth}{images/week-2-1b.jpg}
      
      \item Basement membrane (BM)
      
      \Image{0.8\columnwidth}{images/week-2-1c.jpg}
    \end{itemize}
    \end{multicols}
    \item \jjj{Ciliated pseudostratified columnar epithelium (PsEp)}

     \Image{0.9\columnwidth}{images/week-2-2a.jpg}

     \begin{multicols}{3}
      \begin{itemize}
        \item Goblet c.
        
        \Image{0.8\columnwidth}{images/week-2-2b.jpg}
        
        \item Cilia
        
        \Image{0.8\columnwidth}{images/week-2-2c.jpg}
        
        \item BM
        
        \Image{0.8\columnwidth}{images/week-2-2d.jpg}
    ...
    \item \jjj{Stratified squamous epithelium}
     ...
     \Image{0.85\columnwidth}{images/week-2-3a.jpg}

     \begin{multicols}{2}
      \begin{itemize}
        \item Cell nuclei
        
        \Image{0.8\columnwidth}{images/week-2-3c.jpg}
        
        \item BM
        
        \Image{0.8\columnwidth}{images/week-2-3b.jpg}
      \end{itemize}
      \end{multicols}

    \item \jjj{Simple cuboidal epithelium}

     \Image{0.9\columnwidth}{images/week-2-4a.jpg}
      ...
      \begin{itemize}
        ...
        \begin{center}
          \Image{0.5\columnwidth}{images/week-2-4b.jpg}
        \end{center}
      \end{itemize}

    \item \jjj{Simple columnar epithelium}
    
     \Image{0.8\columnwidth}{images/week-2-5a.jpg}

      \begin{itemize}
        \item Microvillous border
        
        \Image{0.35\columnwidth}{images/week-2-5b.jpg}
        
        \item Goblet cells
        
        \Image{0.35\columnwidth}{images/week-2-5c.jpg}
      \end{itemize}
...
\begin{itemize}
  ...
  \begin{itemize}
    ...
    \Image{0.9\columnwidth}{images/week-2-6a.jpg}

    \begin{itemize}
      \item Collagenous tissue
      \begin{center}
        \Image{0.5\columnwidth}{images/week-2-6b.jpg}
      \end{center}
    \end{itemize}
    ...
    \Image{0.9\columnwidth}{images/week-2-7a.jpg}

    \begin{multicols}{2}
    \begin{itemize}
      \item Reticular fibers
      
      \Image{0.8\columnwidth}{images/week-2-7b.jpg}
      
      \item Collagen (type I)
      
      \Image{0.8\columnwidth}{images/week-2-7c.jpg}
    \end{itemize}
    \end{multicols}

    \item \jjj{Loose connective tissue}

    \Image{0.9\columnwidth}{images/week-2-8a.jpg}

    \begin{multicols}{2}
      \begin{itemize}
        \item Nuclei
        
        \Image{0.8\columnwidth}{images/week-2-8b.jpg}
        
        \item \amp{Elastin} \rrr{fibers}
        
        \Image{0.8\columnwidth}{images/week-2-8c.jpg}

        \item Matrix
        
        \Image{0.8\columnwidth}{images/week-2-8d.jpg}
        
        \item \bbb{Collagen} \xxx{fibers}
        
        \Image{0.8\columnwidth}{images/week-2-8e.jpg}
      \end{itemize}
      \end{multicols}

    \item \jjj{Lymph node reticular fibers}

    \Image{0.9\columnwidth}{images/week-2-9a.jpg}

    \item \jjj{Muscle tendon junctions}

    \Image{0.9\columnwidth}{images/week-2-10a.jpg}
    ...
    \begin{multicols}{2}
      \begin{itemize}
        ...
        \Image{0.82\columnwidth}{images/week-2-10b.jpg}
        
        \item Fibroblasts
        
        \Image{0.85\columnwidth}{images/week-2-10c.jpg}
      \end{itemize}
      \end{multicols}
    ...
    \Image{0.9\columnwidth}{images/week-2-11a.jpg}

    \begin{itemize}
      \item Thick collagenous fibers type I
      
      \begin{center}
        \Image{0.5\columnwidth}{images/week-2-11b.jpg}
      \end{center}
    \end{itemize}
  \end{itemize}
  \end{multicols}
...
\begin{itemize}
  ...
  \begin{itemize}
    ...
    \Image{0.9\columnwidth}{images/week-2-12a.jpg}
    ...
    \begin{itemize}
      ...
      \Image{0.8\columnwidth}{images/week-2-12b.jpg}
      
      \item Inner Perichondrium 
      
      \Image{0.8\columnwidth}{images/week-2-12c.jpg}

      \item Outer Perichondrium
      
      \Image{0.8\columnwidth}{images/week-2-12d.jpg}

      \item Chondrocytes

      \Image{0.8\columnwidth}{images/week-2-12e.jpg}
    \end{itemize}
    \end{multicols}
    ...
    \Image{0.9\columnwidth}{images/week-2-13a.jpg}

    \item \jjj{Fibrocartilage}

    \Image{0.9\columnwidth}{images/week-2-14a.jpg}
  \end{itemize}
  \end{multicols}
  ...
  \subsection{Bone Examples}\label{Bone Examples}
  \begin{itemize}
    \item \jjj{Ground bone cross-section and longitudinal-section}

    \Image{0.44\columnwidth}{images/week-2-15a.jpg}
    \quad
    \Image{0.43\columnwidth}{images/week-2-16a.jpg}

    \bigskip

    \begin{multicols}{2}
    \begin{itemize}
      \item Osteons canal (HC)
      
      \Image{0.77\columnwidth}{images/week-2-16b.jpg}
      
      \item Axial canals
      
      \Image{0.8\columnwidth}{images/week-2-16c.jpg}

      \item Lacunae (L)
      
      \Image{0.75\columnwidth}{images/week-2-16e.jpg}

      \medskip

      \item Canaliculi \(\uparrow \)
      
      \Image{0.75\columnwidth}{images/week-2-16d.jpg}
    \end{itemize}
    \end{multicols}
    ...
    \Image{0.9\columnwidth}{images/week-2-17a.jpg}

    \begin{multicols}{2}
    \begin{itemize}
      \item Compact bone 
    
      \Image{0.88\columnwidth}{images/week-2-17b.jpg}
      
      \medskip

      \item Spongy bone
      
      \Image{0.88\columnwidth}{images/week-2-17c.jpg}

      \item Osteoblasts
      
      \Image{0.88\columnwidth}{images/week-2-17d.jpg}
            
      \medskip

      \item Osteoclasts (Ocl)
      
      \Image{0.88\columnwidth}{images/week-2-17e.jpg}
    \end{itemize}
    \end{multicols}
    \end{multicols}
    ...
    \Image{0.9\columnwidth}{images/week-2-18a.jpg}

    \begin{multicols}{3}
    \begin{itemize}
      \item Resting zone
      
      \Image{0.8\columnwidth}{images/week-2-18b.jpg}
      
      \item Zone of proliferation
      
      \Image{0.8\columnwidth}{images/week-2-18c.jpg}

      \item Zone of hypertrophy
      
      \Image{0.8\columnwidth}{images/week-2-18d.jpg}
      
      \medskip

      \item Zone of calcification
      
      \Image{0.8\columnwidth}{images/week-2-18e.jpg}

      \item Zone of ossification
      
      \Image{0.8\columnwidth}{images/week-2-18f.jpg}

      \Image{0.8\columnwidth}{images/week-2-18g.jpg}
