...
\begin{itemize}
    ...
    \item \textit{Primary sensory areas} posses four properties characteristic of their role in the early stages of information processing:
        \begin{itemize}
    ...
    \item Large regions of association cortex are contained within each of the four lobes:
        \begin{itemize}
            \item \textit{parietal}: critical for sensory guidance of motor behavior and spatial awareness.
            \item \textit{temporal}: recognition of sensory stimuli and for storage of semantic (factual) knowledge.
            \item \textit{frontal}: key role in organizing behavior in working memory.
            \item \textit{limbic}: complex functions related to emotion and episodic (autobiographical) memory.
        \end{itemize}
