...
\begin{chapbox}{\hyperlink{home}{Chapter 41: Nutrition}}
    \begin{enumerate}
        \item \hyperlink{41.1}{Nutritional Requirements}
        \item [3.]\hyperlink{41.3}{How Are Nutrients Digested
        and Absorbed?}
        \item \hyperlink{41.4}{Nutritional Homeostasis}
    \end{enumerate}
\end{chapbox}
...
\begin{secbox}{\hyperlink{41}{Nutritional Requirements}}{
    \begin{itemize}
        \item Ingestion
        \item digestive tract
        \item digestion
        \item absorption
        \item essential nutrient
...
\begin{secbox}{\hyperlink{41}{How are Nutrients Digested and Absorbed}}{
    \begin{itemize}
        \item Incomplete digestive tracts 
        \item Complete digestive tracts
        \item feces
...
\begin{probbox}{Chapter 41: Review}\end{probbox}
