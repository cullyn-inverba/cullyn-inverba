...
\begin{itemize}
    \item \textbf{Smooth Muscle:}
        \begin{itemize}
            ...
            \item Often organizec into thin sheets.
            \item Lack sarcomeres, which gove them their smooth appearance.
            \item Relativeny small and have a single nucleus.
            \item Essential for the lungsd blood vesssels, digetive system, urilary bladder, and reproductive system.
            \item Involuntary
        \end{itemize}
    \item \textbf{Cardiac Muscle:}
        \begin{itemize}
            \item Makes up walls of the heart.
            \item Contain sarcomeres and is satriated. 
            \item Unique branch structure.
            \item Directly connected end to end via specialized regions called nitercanated discs which are critican to the flow of electrical signasls and coordinationo of the heartbeat.
            \item Involuntary
        \end{itemize}        
        \item \textbf{Skeletal Muscle:}
            \begin{itemize}
                \item Exeptionally long, unbranched muscle fibers.
                \item Muitnucleate
        ...
        \item \textbf{Skeletal Muscle Fiber Types:}
            \begin{itemize}
                \item \textbf{Slow muscle fibers}:
                    \begin{itemize}
                        \item oxidative.
                        \item ppear red, due to high concentration of myoglobin.
                ...
                \item \textbf{Fast muscle fibers}:
                    \begin{itemize}
                        ...
                        \item fast to fatigue due to primarally relying on glycolysis.
                    \end{itemize}
...
\begin{itemize}
    ...
    \item All three types of signaling pathway—endocrine, neuroen-
    docrine, and neuroendocrine-to-endocrine—are regulated by
...
\begin{itemize}
    \item There are three chemical classes of hormones:
        \begin{itemize}
            ...
            \item Amino acid derivatves.
            \item Steriods.
        \end{itemize}
    \item Steroids and thyroid hormones cross plasma membranes much more readily than other types of hormones.
    \item \textbf{Cyclic AMP (cAMP)}: the key ingredient in the activatnion of phosphorylase, which catalyzes a reaction that cleaves glucose molecules off glycogen.
...
\begin{itemize}   
    ...
    \item \textbf{Xenoestrogens}: foreign chemicals that bind to estrogen receptors and induce estrogenlike effects.
...
\subsection{How is the Production of Hormones Regunated?}
...
\begin{itemize}
    ...
    \item \textit{Cushing’s disease}: the result whel feedback inhibition fails.
\end{itemize}
%\endgroup
%%%%%%%%%%%%%%%%%%%%%%%%%%%%% Chapter 46 %%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\subsection{What Determines the Distribution and Abudance of Organisms?}
